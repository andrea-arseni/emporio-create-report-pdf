    ...
    const zona = immobile.comune==='segrate'||immobile.comune==='milano' ? immobile.comune+"/"+immobile.zona : immobile.comune;
        try{
            ...
            return {
                ...
                prezzoMetroQuadro : porzioneHTMLconDati.split('nd-cgHighlighted__text">')[index].split("</p>")[0],
                range : porzioneHTMLconDati.split('<p class="nd-cgHighlighted__subtext">')[index].split("</p>")[0]
            };
        }catch(e){
            console.log(e);
